### Benchmark tests presented in Fig. 2 of LaManna et al. 2000 Ecosphere - Conspecific negative density dependence and why its study should not be abandonded
### showing the relabeling model used by Detto et al. 2019 induces false density dependence. 
### Script also demonstrates that the dispersal-kernel model modified from LaManna et al. 2018 can accurately recover a known value of CNDD. 
###
...
##############################################################################################################################################
# Compare null-model performance at recovering a known value of CNDD (using same initial values as in section IV above, with known CNDD = 0.0)
